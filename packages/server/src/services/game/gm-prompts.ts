...
export function buildGmFormatReminder(
  ...
  */
  ...
  lines.push(
    ...
    `- Quoted speech in the player's inputs is spoken aloud verbatim. Unquoted player text not describing a speech act is narration, action, or internal thought; NPCs cannot perceive it unless the player makes it observable or says it out loud.`,
